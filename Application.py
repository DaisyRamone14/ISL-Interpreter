...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("ISL TO TEXT INTERPRETER")
        ...
        self.T.config(text = "ISL TO TEXT INTERPRETER",fg = "blue",font = ("Georgia", 40, "bold"))
        ...
        self.T1.config(text = "Alphabet: ", font = ("Georgia", 30, "bold"))

        self.panel4 = tk.Label(self.root) # Alphabet
        self.panel4.place(x = 220, y = 595)

        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 595)
        self.T2.config(text = "Word: ", font = ("Georgia", 30, "bold"))
        ...
        self.T3.config(text = "Sentence: ",font = ("Georgia", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 250, y = 690)
        self.T4.config(text = "Suggestion: ", fg = "green", font = ("Georgia", 30, "bold"))
